...
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/Pantallas/alumnos-cuotas.php';
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formCrearPago" name="formCrearPago" action="/Includes/sqluser.php" method="POST">
...
(document).ready(function() {
    ...
    $('#formCrearPago').on('submit', function(event) {
        ...
        $.ajax({
            url: "/Includes/sqluser.php", // Reemplaza con la ruta correcta a tu archivo PHP
            type: "POST",
            data: {
...
$(document).ready(function() {
    ...
    function obtenerLegajoPorAlumno(alumnoId) {
        $.ajax({
            url: '/Includes/funcionesLegajo.php', // Ruta correcta al archivo PHP
            type: 'POST',
            data: {
