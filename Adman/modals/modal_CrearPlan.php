...
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/subPantallas/lista_planes.php';
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formCrearPlan" name="formCrearPlan" action="/Includes/sqluser.php" method="POST">
