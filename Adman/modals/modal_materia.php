...
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/subPantallas/lista_materia.php';
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formMateria" name="formMateria" action="/Includes/slqeditar.php" method="POST">
...
$(document).ready(function() {
    ...
    $('#formMateria').on('submit', function(event) {
        ...
        $.ajax({
            url: "/Includes/slqeditar.php", // Reemplaza con la ruta correcta a tu archivo PHP
            type: "POST",
            data: {
                idMateria: idMateria,
