<?php
//require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/ModelsPlan/crearPlan.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/includes/header.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Includes/load.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/modal_EditarPlan.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/modal_carrera.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/modal_CrearPlan.php';
...
<main class="app-content">
        ...
        <nav class="custom-nav">
            <div class="menu-group">
                <ul class="custom-menu-list">
                    ...
                    <li class="custom-menu-item">
                        <a class="custom-menu-link" href="/Adman/Pantallas/carreras.php">Nuestras Carreras</a>
            ...
            <div class="menu-group">
                <ul class="custom-menu-list">
                    <!-- Planes de Estudio -->
                    <li class="custom-menu-item">
                        <a class="custom-menu-link" href="/Adman/subPantallas/lista_planes.php">Planes de
                            Estudio</a>
            ...
            <div class="menu-group">
                <ul class="custom-menu-list">
                    <!-- Materias -->
                    <li class="custom-menu-item">
                        <a class="custom-menu-link" href="/Adman/subPantallas/lista_materia.php">Materias</a>
    ...
    <div id="menu-container" class="container">
        ...
        <div class="row espaciado-entre-filas align-items-center">
            ...
            <form id="busquedaForm" class="form-inline mb-5" action="/Adman/subPantallas/lista_planes.php"
                method="GET">
        ...
        <div class="row espaciado-entre-filas">
            <?php
                ...
                foreach ($resultado as $fila) {
                    ...
                    echo '<div>';
                    echo '<form action="/Includes/archivosPlan.php" class="formArchivoPlan" method="post" enctype="multipart/form-data">';
                    ...
                    if ($fila['Descripcion_Documentacion'] !== null) {
                        ...
                        $rutaCompletaArchivo = "/documentos/plan/$nombreArchivo";
        ...
        <div class="row espaciado-entre-plames align-items-center">
            <div class="col-lg-6">
                ...
                <div class="custom-link">
                    <a href="/Adman/Pantallas/carreras.php" title="">
...
$(function() {
    $(".formArchivoPlan input[name='archivoPlan']").on("change", function() {
        ...
        var ruta = "/Includes/archivosPlan.php";
...
function mostrarInfoAdicional(boton) {
    ...
    $.ajax({
        url: '/Adman/modals/modal_carrera.php',
        type: 'POST',
        data: {
                cod_Plan: cod_Plan,
