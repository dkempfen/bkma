...
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/modal_materia.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/editar_materia.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/confirmacionCambioProfesor.php';
        ...
        <nav class="custom-nav">
            ...
            <div class="menu-group">
                <ul class="custom-menu-list">
                    <!-- Planes de Estudio -->
                    <li class="custom-menu-item">
                        <a class="custom-menu-link" href="/Adman/subPantallas/lista_planes.php">Planes de Estudio</a>
...
$(document).ready(function() {
    ...
    $('#tablemateria').on("change", ".onoffswitch-checkbox", function() {
        ...
        $.ajax({
            url: "/Includes/sql.php", // Reemplaza con la ruta correcta a tu archivo PHP
            type: "POST",
            data: {
                id_Materia: id_Materia,
                fk_Estado: fk_Estado
