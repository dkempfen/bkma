...
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/modals.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/crearUsuario.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/edidtar_user.php';
...
if ($pdo) {
    ...
    if (isset($_SESSION['messageAltaUser'])) {
        $messageAltaUser = $_SESSION['messageAltaUser'];
        unset($_SESSION['messageAltaUser']); // Clear the session variable after displaying the message
        showConfirmationMessageAltaUser($messageAltaUser);
    }
