...
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/modalsFinal.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/ModalsFinalEditar.php';
...
function toggleAllMaterias(checkbox) {
    ...
    $.ajax({
        url: "/Includes/sqlaltauser.php", // Ajusta la ruta a tu archivo PHP
        type: "POST",
        data: {
            toggleAll: true,
            estado: estado
