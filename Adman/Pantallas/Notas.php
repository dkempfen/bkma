...
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/altaPrimerNota.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/Adman/modals/AgregarTodasNotas.php';
?>
