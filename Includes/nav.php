...
<aside class="app-sidebar">
  <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="/Imagenes/profiles/<?php echo $nueva_foto; ?>"
      alt="User Image">
    <div>
